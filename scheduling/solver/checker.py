...
def check_constraints(solution: Matrix, schedule: Schedule) -> int:
    ...
    if check_lectures(solution, schedule) != 0:
        return int(1e9)
    ...
    if check_room_occupancy(solution, schedule) != 0:
        return int(1e9)
    ...
    if check_conflicts(solution, schedule) != 0:
        return int(1e9)
    ...
    if check_availabilities(solution, schedule) != 0:
        return int(1e9)
